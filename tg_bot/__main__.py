...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("You noob, youdo not have the permission required to use this...😎")
...
def send_start(bot, update):
    ...
    text += "\nMy name is **King Pro Bot** \nAnd I'm the cutest Group Management bot ever! 😉 " 
    text += "\n\n𝐅𝐞𝐞𝐥 𝐟𝐫𝐞𝐞 𝐭𝐨 𝐠𝐞𝐭 𝐦𝐞 𝐢𝐧𝐭𝐨 𝐲𝐨𝐮𝐫 𝐠rou𝐩𝐬 and see how I manage them efficiently! 😉..."  
    ...
    keyboard += [[InlineKeyboardButton(text="💠Add Me💠",url="http://t.me/zoldycktmbot?startgroup=true"),InlineKeyboardButton(text="♻️Owner",url="https://t.me/nextlevelboss ")]]
