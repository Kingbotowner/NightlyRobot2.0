...
def makepack_internal(msg, user, png_sticker, emoji, bot, packname, packnum):
    ...
    try:
        ...
        success = bot.create_new_sticker_set(user.id, packname, f"{name}'s King Dee Pack" + extra_version,
        ...
        if e.message == "Sticker set name is already occupied":
            ...
            msg.reply_text("Contact me in PM first.", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(
                ...
                msg.reply_text("Sticker pack successfully created by **King Pro Bot** ! Get it [here](t.me/addstickers/%s)" % packname,
                       parse_mode=ParseMode.MARKDOWN)
        return
